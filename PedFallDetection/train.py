...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='models/yolov5sSimAMCARAFE.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='/PedFall/PedFall.yaml', help='data.yaml path')
    ...
    parser.add_argument('--logdir', type=str, default='PedFall/logs', help='logging directory')
