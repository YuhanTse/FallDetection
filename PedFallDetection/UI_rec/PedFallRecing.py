...
from PedFall.label_name import Chinese_name
...
class PedFall_MainWindow(QBeautyUI):
    def __init__(self, *args, obj=None, **kwargs):
        super(PedFall_MainWindow, self).__init__(*args, **kwargs)
    ...
    def LoadModel(self, model_path=None):
        ...
        parser.add_argument('--weights', nargs='+', type=str, default='../weights/pedfall-best.pt',
